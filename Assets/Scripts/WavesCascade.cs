...
public class WavesCascade
{
    ...
    public readonly RenderTexture DxDz;
    public readonly RenderTexture DyDxz;
    public readonly RenderTexture DyxDyz;
    public readonly RenderTexture DxxDzz;
